...
model = load_model('diamond_random_forest_regressor.pkl')
...
Carat_Weight = st.sidebar.number_input(label = 'Carat Weight', value = 2.0)
...
features = {'Carat Weight':Carat_Weight,
            'Cut':Cut,
            'Color':Color,
'Clarity':Clarity,
'Polish':Polish,
